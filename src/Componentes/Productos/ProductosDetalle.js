        ...
        <>
            {
                <div className="detalles">
                    ...
                    <div className="descripcion">
                        <p><b>Descripción:</b>Lorem ipsum dolor sit amet consectetur adipiscing elit condimentum nec scelerisque, felis rutrum tempor quis senectus urna donec faucibus augue ad, <br/> curae nascetur habitant varius cubilia viverra ultricies pretium potenti.  
                        Sociis turpis leo augue etiam magna auctor maecenas id sodales bibendum luctus, suspendisse tempor nunc massa urna rhoncus odio pellentesque condimentum egestas, posuere torquent eget sed nostra mus ligula gravida curabitur in.</p>
                        <br/>
                        <br/>
                        <br/>
                        <br/>
